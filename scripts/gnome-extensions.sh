...
sudo unzip bluetooth-quick-connectbjarosze.gmail.com.v34.shell-extension.zip -d /usr/share/gnome-shell/extensions/bluetooth-quick-connect@bjarosze.gmail.com/
...
sudo unzip clipboard-indicatortudmotu.com.v47.shell-extension.zip -d  /usr/share/gnome-shell/extensions/clipboard-indicator@tudmotu.com/
...
sudo unzip emoji-selectormaestroschan.fr.v23.shell-extension.zip -d  /usr/share/gnome-shell/extensions/emoji-selector@maestroschan.fr/
...
sudo unzip sound-output-device-chooserkgshank.net.v43.shell-extension.zip -d  /usr/share/gnome-shell/extensions/sound-output-device-chooser@kgshank.net/
...
sudo unzip VitalsCoreCoding.com.v61.shell-extension.zip -d  /usr/share/gnome-shell/extensions/Vitals@CoreCoding.com/
...
sudo unzip wintilenowsci.com.v15.shell-extension.zip -d  /usr/share/gnome-shell/extensions/wintile@nowsci.com/
